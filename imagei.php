	...
	<div class="container">
		<div class="row">
			<div class="col-md-4 offset-md-4 form">
				<form action="imagei2.php" method="POST" enctype="multipart/form-data" autocomplete="">
					<h2 class="text-center" href=>UPLOAD PROFILE PIC</h2>
					<br>
					<div class="form-group">
						<input class="" type="file" name="my_image">
					</div>
					<br>
					<div class="form-group">
						<input class="form-control button" type="Submit" name="submit" value="Upload">
					</div>
				</form>
			</div>
		</div>
